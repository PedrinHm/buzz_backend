...
@router.post("/bus_stops/", response_model=schemas.BusStop)
...
@router.get("/bus_stops/", response_model=List[schemas.BusStop])
...
@router.get("/bus_stops/{bus_stop_id}", response_model=schemas.BusStop)
...
@router.put("/bus_stops/{bus_stop_id}", response_model=schemas.BusStop)
...
@router.delete("/bus_stops/{bus_stop_id}", response_model=dict)
